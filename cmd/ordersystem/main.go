...
import (
	...
	"github.com/EnnioSimoes/CleanArch/internal/event/handler"
...
func main() {
	...
	webserver.AddHandler("GET", "/orders", webOrderHandler.GetAll)

	fmt.Println("Starting web server on port", configs.WebServerPort)
	go webserver.Start()

	grpcServer := grpc.NewServer()
	createOrderService := service.NewOrderService(*createOrderUseCase, *listOrderUseCase) // Pass the listOrderUseCase to the service
